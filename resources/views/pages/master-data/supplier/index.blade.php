        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            {{-- Content --}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <h4 class="card-header">Daftar Supplier Produk</h4>
                            <!-- Account -->
                            <div class="card-body">
                                <div class="d-flex justify-content-end align-items-end align-items-sm-center gap-4">
                                    <div class="button-wrapper">
                                        <button type="button" class="btn rounded-pill btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                                            Tambah Supplier Produk<span class="tf-icons bx bx-plus-circle ms-1"></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table table-striped w-100" id="dtindex_produk">
                                    <thead>
                                        ...
                                        <th>Kode Supplier Produk</th>
                                        <th>Merek Supplier</th>
                                        <th>Jumlah Produk</th>
                                        <th>Aksi</th>
                                    </thead>
                                    <tbody>
                ...
                <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <h5 class="modal-title" id="exampleModalLabel3">Tambah Supllier Produk</h5>
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Masukan nama supplier" aria-describedby="floatingInputHelp" />
                                            <label for="floatingInput">Supplier Produk</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col mb-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Masukan nama supplier" aria-describedby="floatingInputHelp" />
                                            <label for="floatingInput">Telepon Supplier</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            {{-- Edit Modal --}}
                <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel3">Ubah Supplier Produk</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
            ...
            {{-- Detail Modal --}}
                <div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel3">Detail Supplier Produk</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col mb-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Masukan nama supplier" aria-describedby="floatingInputHelp" disabled/>
                                            <label for="floatingInput">Supplier Produk</label>
                                        </div>
                                    </div>
                                </div>
            ...
            {{-- Delete Modal --}}
                <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel3">Hapus Supplier Produk</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
                            </div>
                            <div class="modal-body">
